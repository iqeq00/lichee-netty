...
public final class StudentServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<StreamRequestInfo,
      StreamResponseInfo> getBiTalkMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "biTalk",
      requestType = StreamRequestInfo.class,
      responseType = StreamResponseInfo.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<StreamRequestInfo,
      StreamResponseInfo> getBiTalkMethod() {
    io.grpc.MethodDescriptor<StreamRequestInfo, StreamResponseInfo> getBiTalkMethod;
    if ((getBiTalkMethod = StudentServiceGrpc.getBiTalkMethod) == null) {
      synchronized (StudentServiceGrpc.class) {
        if ((getBiTalkMethod = StudentServiceGrpc.getBiTalkMethod) == null) {
          StudentServiceGrpc.getBiTalkMethod = getBiTalkMethod = 
              io.grpc.MethodDescriptor.<StreamRequestInfo, StreamResponseInfo>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "grpc.StudentService", "biTalk"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  StreamRequestInfo.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  StreamResponseInfo.getDefaultInstance()))
  ...
  public static abstract class StudentServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<StreamRequestInfo> biTalk(
        io.grpc.stub.StreamObserver<StreamResponseInfo> responseObserver) {
